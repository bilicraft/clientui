...
public class BilicraftMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	public void initGui() {
		...
		this.buttonList.add(new BilicraftCustomButton(23, this.width / 2 + 104, i + 72 + 12, 20, 20,
				"bcgui:buttons/btn-bc-normal.png", "bcgui:buttons/btn-bc-hover.png", "官网"));
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		GuiButtonExt bilicraftbutton = new GuiButtonExt(22, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1,
				"Enter the Bilicraft");
		...
		if (BilicraftUI.isDebug()) {
			GuiButtonExt multibutton = new GuiButtonExt(2, this.width / 2 + 102, p_73969_1_ + p_73969_2_ * 1,
