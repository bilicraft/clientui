...
public class BilicraftMainMenu extends GuiScreen implements GuiYesNoCallback {
    public static final String field_96138_a = "请点" + EnumChatFormatting.UNDERLINE + "这里" + EnumChatFormatting.RESET
	    + "获取更多信息";
	...
	try {
	    ...
	    bufferedreader = new BufferedReader(new InputStreamReader(Minecraft.getMinecraft().getResourceManager()
		    .getResource(BilicraftMainMenu.splashTexts).getInputStream(), Charsets.UTF_8));
	...
	if (p_73869_2_ == 15) {
	    ...
	    } else if (password.isFocused() && !email.isFocused()) {
	...
	bilicraftbutton = new GuiButtonExt(22, this.width / 2 - 100, p_73969_1_ + p_73969_2_, "Enter the Bilicraft");
